     ...
     <div className="wrapper flex">
       <div className="sign flex">
         <div className="signForm">
           <h1>Want to know the release date for our website? </h1>
           <p>Signup to receive updates now.</p>
           <form className="signForm__field">
             ...
             <a href="/" className="signForm__forgot">Forgot your password</a>
             <button datatype='blue' type='submit'>Sign in</button>
           </form>
         </div>
